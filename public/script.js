...
const socialIconPaths = {
  ...
  instagram:
    '<path d="M16 9.1a6.9 6.9 0 1 0 0 13.8 6.9 6.9 0 0 0 0-13.8Zm0 11.4a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9Zm8.8-11.7a1.6 1.6 0 1 1-3.2 0 1.6 1.6 0 0 1 3.2 0Z" /><path d="M23.3 4.8H8.7a3.9 3.9 0 0 0-3.9 3.9v14.6a3.9 3.9 0 0 0 3.9 3.9h14.6a3.9 3.9 0 0 0 3.9-3.9V8.7a3.9 3.9 0 0 0-3.9-3.9Zm1.5 18.5c0 .8-.7 1.5-1.5 1.5H8.7c-.8 0-1.5-.7-1.5-1.5V8.7c0-.8.7-1.5 1.5-1.5h14.6c.8 0 1.5.7 1.5 1.5v14.6Z" />',
  linkedin:
...
function renderSocialLinks() {
  document.querySelectorAll("[data-social-links]").forEach((container) => {
    container.innerHTML = SOCIAL_LINKS.map((item) => {
      const iconPath = socialIconPaths[item.icon] || "";
      return `
        <a class="social-link" href="${item.url}" target="_blank" rel="noopener noreferrer" aria-label="AXDCARE on ${item.platform}">
          <svg viewBox="0 0 32 32" aria-hidden="true" focusable="false">${iconPath}</svg>
